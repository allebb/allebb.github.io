                ...
                <div class="span8 dropme">
                    <section>
                        ...
                        <ul>
                            ...
                            <li><a href="https://github.com/bobsta63/ravish" target="_blank">Ravish</a> - A cURL-less HTTP client library for PHP (perfect for JSON and XML web services!). <span class="label">Composer compatible!</small></li>
                            <li><a href="https://github.com/bobsta63/likkle" target="_blank">Likkle</a> - A short URL generation and statistics PHP library for use with the <a href="http://www.lk2.in/" target="_blank">lk2.in</a> web service.  <span class="label">Composer compatible!</small></li>
                            <li><a href="https://github.com/bobsta63/gravel" target="_blank">Gravel</a> - A Gravatar.com library enabling developers easy access, display and manipulate user avatars in their applications.  <span class="label">Composer compatible!</small></li>
                            <li><a href="https://github.com/bobsta63/distical" target="_blank">Distical</a> - A Lat/Long distance calculation library for PHP.  <span class="label">Composer compatible!</small></li>
